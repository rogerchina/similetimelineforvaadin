...
public class WidgetMapImpl extends com.vaadin.terminal.gwt.client.WidgetMap {
  public Class<? extends Paintable> getImplementationByServerSideClassName(String fullyQualifiedName) {
    ...
    if ( fullyQualifiedName == "com.vaadin.ui.RichTextArea" ) { ensureInstantiator(com.vaadin.terminal.gwt.client.ui.richtextarea.VRichTextArea.class); return com.vaadin.terminal.gwt.client.ui.richtextarea.VRichTextArea.class;}
    ...
    else if ( fullyQualifiedName == "org.vaadin.chronographer.ChronoGrapher" ) { ensureInstantiator(org.vaadin.chronographer.gwt.client.ui.VChronoGrapher.class); return org.vaadin.chronographer.gwt.client.ui.VChronoGrapher.class;}
  ...
  if( classType == com.vaadin.terminal.gwt.client.ui.richtextarea.VRichTextArea.class) {instmap.put(com.vaadin.terminal.gwt.client.ui.richtextarea.VRichTextArea.class, new WidgetInstantiator() {
...
);} else if( classType == org.vaadin.chronographer.gwt.client.ui.VChronoGrapher.class) {instmap.put(org.vaadin.chronographer.gwt.client.ui.VChronoGrapher.class, new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(org.vaadin.chronographer.gwt.client.ui.VChronoGrapher.class );
  }
  }
